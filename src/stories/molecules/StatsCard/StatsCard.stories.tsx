...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'An enhanced statistics card with icon, trend indicators, and multiple color themes. Designed for comprehensive barangay dashboard displays.',
      },
    },
  },
  tags: ['autodocs'],
...
export const BarangayDashboard: Story = {
  render: () => (
    <div className="grid min-h-screen grid-cols-1 gap-6 bg-gray-50 p-6 md:grid-cols-2 lg:grid-cols-3">
      <StatsCard
        title="Kabuuang Populasyon"
        value="2,847"
        icon={<PopulationIcon />}
