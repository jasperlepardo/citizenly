...
import EmploymentStatusPieChart from '@/components/molecules/EmploymentStatusPieChart';

const meta = {
  title: 'Molecules/EmploymentStatusPieChart',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A specialized pie chart for displaying employment status distribution in Filipino barangays. Shows breakdown of employed, unemployed, self-employed, students, retirees, homemakers, disabled, and other employment categories.',
      },
    },
  },
  tags: ['autodocs'],
