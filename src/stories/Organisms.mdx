...
```tsx
// ✅ Good: Complete functional section
<PersonalInformation
  value={personalData}
...
// ❌ Bad: Too simple (should be a molecule)
<SimpleCard>
  <CardTitle>Title</CardTitle>
  <CardContent>Content</CardContent>
</SimpleCard>

// ❌ Bad: Too complex (should be broken into multiple organisms)
<MegaForm>
  <PersonalInfo />
  <AddressInfo />
  <EmploymentInfo />
