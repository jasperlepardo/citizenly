...
const mockBottomNavigation: NavigationItem[] = [
  ...
  { 
    ...
    icon: ({ className }) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c0-1.628 1.32-2.948 2.948-2.948s2.948 1.32 2.948 2.948c0 1.628-1.32 2.948-2.948 2.948s-2.948-1.32-2.948-2.948zM12 16.5V14m0 0V9.75m0 4.25h.008v.008H12v-.008z" />
      </svg>
    )
  },
];
...
const MockFooter = () => (
  <div className="text-center">
    ...
    <p className="text-xs text-gray-500 dark:text-gray-400">
      v2.1.0 | Barangay Anuling Cerca I
    </p>
  </div>
);
...
const meta: Meta<typeof Sidebar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A comprehensive sidebar navigation component for Philippine barangay management systems. Features collapsible design, mobile responsiveness, and government-compliant styling.',
      },
    },
  },
  argTypes: {
    ...
    (Story) => (
      <div className="h-screen flex bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex-1 p-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 h-full p-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Main Content Area</h1>
            <p className="text-gray-600 dark:text-gray-400">
              This is the main content area. The sidebar provides navigation for the Philippine barangay management system.
            </p>
          </div>
        </div>
      </div>
    ...
    (Story) => (
      <div className="h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="ml-64 p-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 h-full p-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Fixed Sidebar Layout</h1>
            <p className="text-gray-600 dark:text-gray-400">
...
export const MobileOverlay: Story = {
  ...
  decorators: [
    (Story) => (
      <div className="h-screen bg-gray-50 dark:bg-gray-900 lg:flex">
        <Story />
        <div className="flex-1 p-4 lg:p-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 h-full p-4 lg:p-6">
            <h1 className="text-xl lg:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Mobile View</h1>
            <p className="text-gray-600 dark:text-gray-400">
...
export const GovernmentTheme: Story = {
    ...
    logo: (
      <div className="h-8 w-8 flex items-center justify-center">
        <div className="flex space-x-0.5">
          <div className="w-2 h-6 bg-blue-600 dark:bg-blue-500"></div>
          <div className="w-2 h-6 bg-red-600 dark:bg-red-500"></div>
          <div className="w-2 h-6 bg-yellow-500 dark:bg-yellow-400"></div>
        </div>
      </div>
    ),
  ...
  parameters: {
    docs: {
      description: {
        story: 'Philippine government themed sidebar with Filipino language navigation items and flag-inspired logo design.',
      },
    },
  },
};
    ...
    (Story) => (
      <div className="dark">
        <div className="h-screen flex bg-gray-50 dark:bg-gray-900">
          ...
          <div className="flex-1 p-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 h-full p-6">
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Dark Mode</h1>
              <p className="text-gray-600 dark:text-gray-400">
                The sidebar supports dark mode with proper contrast and Philippine government accessibility standards.
              </p>
            </div>
          </div>
        </div>
