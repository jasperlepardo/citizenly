...
- **FormField** - Generic wrapper for form controls
...
```tsx
// ✅ Good: Using a molecule for related functionality
<InputField
  label="Email Address"
  type="email"
  value={email}
...
// ✅ Good: Configurable molecule for different contexts
<StatCard
  icon={<UserIcon />}
...
// ✅ Good: Molecule handling complex interaction
<SearchBar
...
// ❌ Bad: Too simple (should be atoms instead)
<div className="button-wrapper">
  <Button>Click me</Button>
</div>

// ❌ Bad: Too complex (should be an organism)
<ComplexForm>
  <InputField />
  <SelectField />
  <FileUpload />
