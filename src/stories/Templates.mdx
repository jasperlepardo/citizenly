...
```tsx
// ✅ Good: Template with flexible content areas
<MainLayout
...
// ✅ Good: Form template with configurable steps
<HouseholdFormWizard
...
// ✅ Good: Dashboard template with flexible widgets
<DashboardLayout
...
// ❌ Bad: Template with hard-coded content
...
// ❌ Bad: Template that's too specific
