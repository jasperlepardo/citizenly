...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const hasPermission = (permission: string): boolean => {
    ...
    if (resource && action && role.permissions[resource]) {
      ...
      if (action === 'view' && (permissionValue === 'read' || permissionValue === 'crud')) return true
      if (action === 'create' && (permissionValue === 'write' || permissionValue === 'crud')) return true
      if (action === 'update' && (permissionValue === 'write' || permissionValue === 'crud')) return true
      if (action === 'delete' && (permissionValue === 'write' || permissionValue === 'crud')) return true
    }
