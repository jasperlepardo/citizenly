      ...
      <div className="p-6">
              ...
              Object.entries(groupedContent).map(([category, items]) => (
                <div key={category} className="space-y-4">
                  ...
                  <div className="border-b border-default pb-2">
                    <h3 className="font-montserrat flex items-center space-x-2 text-lg font-semibold text-gray-600">
                      ...
                      return (
                        ...
                        >
                          <button
                            ...
                            className="bg-default-muted hover:bg-default-hover w-full p-4 text-left transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500"
                          >
                          ...
                          {isAccordionOpen(globalIndex) && (
                            <div className="bg-default border-t border-default p-4">
        ...
        <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-montserrat mb-2 text-base font-semibold text-gray-900">
                Still need help?
              </h3>
              <p className="font-montserrat mb-4 text-sm text-gray-800">
                If you can&apos;t find the answer you&apos;re looking for, our support team is here
                to help.
              </p>
              <button className="font-montserrat rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
                Contact Support
              </button>
            </div>
          </div>
