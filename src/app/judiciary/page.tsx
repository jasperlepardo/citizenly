    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            <h1 className="font-montserrat font-semibold text-xl text-primary mb-0.5">Judiciary Services</h1>
        ...
        <div className="bg-surface rounded-lg border border-default p-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="bg-surface-hover rounded-lg p-4">
              ...
              <p className="text-xs text-secondary">Track cases, hearings, and legal proceedings digitally</p>
            </div>
            ...
            <div className="bg-surface-hover rounded-lg p-4">
              ...
              <p className="text-xs text-secondary">Facilitate dispute resolution and community mediation</p>
            </div>
            ...
            <div className="bg-surface-hover rounded-lg p-4">
              ...
              <p className="text-xs text-secondary">Maintain comprehensive legal documentation and archives</p>
            </div>
          </div>
