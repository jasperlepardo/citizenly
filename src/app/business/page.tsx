    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            <h1 className="font-montserrat font-semibold text-xl text-neutral-900 mb-0.5">Business Registration</h1>
        ...
        <div className="bg-white rounded-lg border border-neutral-200 p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-neutral-900 mb-2">Business Management Coming Soon</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="bg-neutral-50 rounded-lg p-4">
              ...
              <h4 className="font-medium text-sm text-neutral-900 mb-1">Business Permits</h4>
              <p className="text-xs text-neutral-600">Track and manage business permit applications and renewals</p>
            </div>
            ...
            <div className="bg-neutral-50 rounded-lg p-4">
              ...
              <h4 className="font-medium text-sm text-neutral-900 mb-1">Tax Records</h4>
              <p className="text-xs text-neutral-600">Monitor business tax compliance and payment history</p>
            </div>
            ...
            <div className="bg-neutral-50 rounded-lg p-4">
              ...
              <h4 className="font-medium text-sm text-neutral-900 mb-1">Analytics</h4>
              <p className="text-xs text-neutral-600">View business registration trends and statistics</p>
            </div>
          </div>
        </div>
      </div>
