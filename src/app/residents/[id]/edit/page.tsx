        ...
        <DashboardLayout>
          <div className="flex min-h-screen items-center justify-center">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-lg font-medium text-gray-600">Loading resident data...</h2>
            </div>
          </div>
        </DashboardLayout>
      </ProtectedRoute>
      ...
      <ProtectedRoute>
        <DashboardLayout>
          <div className="space-y-6">
            <div className="rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-danger-950">
              ...
              <button
                ...
                className="mt-4 rounded bg-red-600 px-4 py-2 text-white hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600"
              >
                Retry
              </button>
            </div>
        ...
        <div className="mx-auto max-w-6xl space-y-6">
          ...
          <div className="bg-default rounded-xl border border-default p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-gray-600">Edit Resident</h1>
