  ...
  return (
    <div className="p-6">
        ...
        <div className="mb-6 flex items-start justify-between">
          ...
          <button className="font-montserrat focus:ring-offset-background rounded-sm px-2 py-1 text-sm font-medium text-gray-600 dark:text-gray-400 transition-colors hover:text-gray-700 dark:text-gray-300 focus:text-gray-800 dark:text-gray-200 focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
            Mark all as read
          </button>
        </div>
                ...
                <button
                  ...
                  className={`font-montserrat whitespace-nowrap border-b-2 px-1 py-2 text-sm font-medium ${
                    filter === tab.id
                      ...
                      : 'hover:border-gray-300 dark:hover:border-gray-600 text-gray-500 dark:text-gray-400 dark:text-gray-600 dark:text-gray-400 border-transparent hover:text-gray-600 dark:text-gray-400'
                  }`}
                >
                  {tab.name}
                  {tab.count > 0 && (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          {filteredNotifications.length === 0 ? (
            <div className="p-8 text-center">
              <div className="bg-gray-100 dark:bg-gray-700 mx-auto mb-4 flex size-16 items-center justify-center rounded-full">
                <svg
                  className="text-gray-500 dark:text-gray-400 size-8"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
              {filteredNotifications.map(notification => (
                <div
                  key={notification.id}
                  className={`hover:bg-gray-50 dark:bg-gray-700 p-4 transition-colors ${
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="font-montserrat mt-1 text-sm text-gray-600 dark:text-gray-400">
                            {notification.message}
                          </p>
                          <p className="font-montserrat text-gray-500 dark:text-gray-400 mt-2 text-xs">
                            {notification.time}
                          </p>
                        </div>
                        <div className="ml-4 flex space-x-2">
                          {!notification.read && (
                            <button className="font-montserrat focus:ring-offset-surface rounded-sm px-2 py-1 text-xs text-gray-600 dark:text-gray-400 transition-colors hover:text-gray-700 dark:text-gray-300 focus:text-gray-800 dark:text-gray-200 focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
                              Mark as read
                            </button>
                          )}
                          <button
                            className="focus:ring-offset-surface text-gray-500 dark:text-gray-400 rounded-sm p-1 transition-colors hover:text-gray-600 focus:text-red-600 focus:outline-hidden focus:ring-2 focus:ring-danger-500 focus:ring-offset-1"
