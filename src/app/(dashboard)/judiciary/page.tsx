        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 text-center">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
              ...
              <h4 className="mb-1 text-sm font-medium text-gray-600 dark:text-gray-300">Case Management</h4>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
              ...
              <h4 className="mb-1 text-sm font-medium text-gray-600 dark:text-gray-300">Mediation Services</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
              ...
              <h4 className="mb-1 text-sm font-medium text-gray-600 dark:text-gray-300">Legal Records</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400">
