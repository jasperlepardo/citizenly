...
function DashboardContent() {
  ...
  const { stats, calculations, isLoading, error } = useDashboard();

  const { sexDistribution, civilStatusData, employmentData, populationData } = calculations;
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div>
          <DependencyRatioPieChart
            ...
            data={
              calculations.dependencyData || { youngDependents: 0, workingAge: 0, oldDependents: 0 }
            }
          />
        </div>
        <div>
