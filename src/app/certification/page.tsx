    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            <h1 className="font-montserrat font-semibold text-xl text-neutral-900 mb-0.5">Certification Services</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {certificateTypes.map((cert, index) => (
            <div key={index} className={`bg-white rounded-lg border p-6 hover:shadow-md transition-shadow ${
              cert.status === 'Available' ? 'border-neutral-200 hover:border-blue-300' : 'border-neutral-200 opacity-75'
            }`}>
              ...
              <h3 className="font-montserrat font-semibold text-base text-neutral-900 mb-2">
                {cert.name}
              </h3>
              <p className="font-montserrat text-sm text-neutral-600 mb-4">
                {cert.description}
              </p>
              <button 
                className={`w-full py-2 rounded font-montserrat font-medium text-sm transition-colors ${
                  cert.status === 'Available'
        ...
        <div className="bg-white rounded-lg border border-neutral-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-montserrat font-semibold text-lg text-neutral-900">Recent Certificate Requests</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-montserrat font-medium text-sm text-neutral-900">Barangay Certificate</h4>
                  <p className="font-montserrat text-xs text-neutral-600">Requested by: Juan Dela Cruz</p>
                </div>
              </div>
              <div className="text-right">
                <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium">Ready</span>
                <p className="font-montserrat text-xs text-neutral-500 mt-1">Dec 15, 2024</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-montserrat font-medium text-sm text-neutral-900">Certificate of Residency</h4>
                  <p className="font-montserrat text-xs text-neutral-600">Requested by: Maria Santos</p>
                </div>
              </div>
              <div className="text-right">
            ...
            <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-montserrat font-medium text-sm text-neutral-900">Barangay Clearance</h4>
                  <p className="font-montserrat text-xs text-neutral-600">Requested by: Pedro Garcia</p>
                </div>
              </div>
              <div className="text-right">
          ...
          <div className="text-center py-8">
            ...
            <h3 className="font-montserrat font-medium text-neutral-900 mb-2">No certificate requests yet</h3>
