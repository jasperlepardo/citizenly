...
import { formatDate as libFormatDate } from '../../../utils/shared/dataTransformers';
 ...
 * @param options - Intl.DateTimeFormatOptions for formatting control
...
export const formatDate = (
  ...
  try {
    // Default to long format for detail views
    const defaultOptions = options || { dateStyle: 'long' };
    return libFormatDate(dateString, defaultOptions);
  } catch {
    return '-';
  }
};
...
/**
 * Formats date for compact display (MM/DD/YYYY)
