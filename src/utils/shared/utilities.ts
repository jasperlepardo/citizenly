...
import { debounce } from '@/utils/shared/asyncUtils';
 ...
 */
export function hasWarnings(_validationResult: SimpleValidationResult): boolean {
 ...
 */
export function createValidationState(): FormValidationState {
  return {
    errors: {},
    isValid: true,
    isDirty: false,
...
export function useValidationState() {
  const [state, setState] = useState<FormValidationState>(createValidationState);
...
export const asyncValidationUtils = {
  ...
  createDebouncedAsyncValidator: (
    ...
    return (_fieldName: string, value: any, onResult: (result: FieldValidationResult) => void) => {
