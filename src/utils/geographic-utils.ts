 ...
 */
export function getPsgcLevel(code: string): 'region' | 'province' | 'city' | 'barangay' | 'unknown' {
 ...
 */
export function isValidPsgcCode(code: string, level?: 'region' | 'province' | 'city' | 'barangay'): boolean {
