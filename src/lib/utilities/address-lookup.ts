...
export function lookupHouseholdTypeLabels(householdData: {
  ...
  if (householdData.householdType) {
    labels.householdTypeLabel = householdTypeMap[householdData.householdType] || householdData.householdType;
  }

  if (householdData.tenureStatus) {
    labels.tenureStatusLabel = tenureStatusMap[householdData.tenureStatus] || householdData.tenureStatus;
  }

  if (householdData.householdUnit) {
    labels.householdUnitLabel = householdUnitMap[householdData.householdUnit] || householdData.householdUnit;
  }

  if (householdData.householdHeadPosition) {
    labels.householdHeadPositionLabel = householdHeadPositionMap[householdData.householdHeadPosition] || householdData.householdHeadPosition;
  }
 ...
 */
export async function lookupHouseholdHeadLabel(householdHeadId?: string): Promise<string | undefined> {
