 ...
 * ```typescript
 * import { AuthState, LoginRequest, AuthUserProfile } from '@/types/app/auth';
 *
 ...
 * ```typescript
 * import { UserRole, ROLE_PERMISSIONS } from '@/types/app/auth';
 *
...
export interface AuthUserProfile {
  // Base user profile fields (database-aligned with snake_case)
  id: string;
  first_name: string;
  last_name: string;
  ...
  role?: AuthRole; // Resolved from role_id
...
export interface AuthRole {
  // Base role fields (database-aligned with snake_case)
  id: string;
  name: string;
  display_name: string;
  description?: string | null;
  permissions: Record<string, unknown>; // JSONB field
  is_active: boolean;
  created_at: string;
  updated_at: string;
 ...
 * Uses camelCase following TypeScript naming conventions
 */
...
/**
 * Authentication result for middleware and API operations
 */
