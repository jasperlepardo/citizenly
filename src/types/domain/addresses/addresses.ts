 ...
 * ```typescript
 * import { AddressInfo, AddressHierarchy } from '@/types/domain/addresses';
 * import { PSGCBarangay } from '@/types/infrastructure/database';
 *
 ...
 * ```typescript
 * import { AddressSearchParams, AddressSearchResult } from '@/types/domain/addresses';
 *
 ...
 * ```typescript
 * import { AddressFormData, AddressSelectionState } from '@/types/domain/addresses';
 *
