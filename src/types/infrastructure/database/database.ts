 ...
 * ```typescript
 * import { ResidentRecord, HouseholdRecord } from '@/types/infrastructure/database';
 *
 ...
 * ```typescript
 * import { PSGCRegion, PSGCProvince, PSGCCityMunicipality, PSGCBarangay } from '@/types/infrastructure/database';
 *
 ...
 * ```typescript
 * import { SexEnum, CivilStatusEnum, EmploymentStatusEnum } from '@/types/infrastructure/database';
 *
