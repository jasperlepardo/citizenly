...
/**
 * Base search options interface (alias for QueryOptions for backward compatibility)
 */
export type BaseSearchOptions = QueryOptions;
...
// =============================================================================
// HOUSEHOLD SERVICE TYPES (using canonical types from @/types/app/ui/forms)
// =============================================================================
 ...
 * Consolidates from src/services/userRepository.ts
 */
