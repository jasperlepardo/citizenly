    ...
    <div className="bg-default flex min-h-screen items-center justify-center">
      <div className="space-y-4 p-8 text-center">
        ...
        <div className="flex justify-center gap-2">
          <button
            onClick={resetError}
            className="text-white rounded-md bg-blue-600 px-4 py-2 transition-colors hover:bg-blue-600/90"
          >
            Try Again
          </button>
          <button
            onClick={() => (window.location.href = '/')}
            className="bg-purple-600 text-white hover:bg-purple-600/90 rounded-md px-4 py-2 transition-colors"
          >
            Go to Homepage
          </button>
        </div>
