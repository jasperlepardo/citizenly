...
function ScaleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75L12 21l4.185-.75A17.8 17.8 0 0 0 12 20.25zm0 0L7.5 21l4.5.75 4.5-.75L12 20.25zm0-16.5L16.5 3l-4.5.75L7.5 3l4.5.75z" />
    </svg>
  )
}
...
function NavigationItemComponent({ item, currentPath, showSubmenu = true, className = "" }: NavigationItemProps) {
          ...
          {item.children?.map((child) => (
            <div key={child.name} className={navigationStyles.submenuItem}>
              <Link href={child.href}>
                <div className={navigationStyles.submenuLink}>
                  {child.name}
                </div>
              </Link>
            </div>
