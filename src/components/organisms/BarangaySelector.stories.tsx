...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A sophisticated barangay selector with real-time search functionality. Connects to the Philippine Standard Geographic Code (PSGC) database to provide accurate barangay selection with autocomplete, search highlighting, and address hierarchy display.'
      }
    }
  },
  tags: ['autodocs'],
      ...
      <div className="space-y-6">
        ...
        <div className="bg-background rounded-lg border border-default p-4">
          ...
          <div className="space-y-2 text-sm">
            <div>
              <strong>Selected Code:</strong> <code className="bg-background-muted px-2 py-1 rounded">{selectedCode || 'None'}</code>
            </div>
            <div>
              <strong>Status:</strong> <span className={selectedCode ? 'text-green-600' : 'text-secondary'}>{selectedCode ? 'Selected' : 'No selection'}</span>
            </div>
          </div>
