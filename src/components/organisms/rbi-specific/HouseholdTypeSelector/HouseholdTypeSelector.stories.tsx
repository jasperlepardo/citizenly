...
const meta: Meta<typeof HouseholdTypeSelector> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Component for selecting household type classification in the RBI system. Provides visual household type selection with icons and descriptions following Philippine household classification standards.',
      },
    },
  },
  tags: ['autodocs'],
...
const HouseholdTypeSelectorTemplate = (args: { value: string; [key: string]: unknown }) => {
...
export const ExtendedFamily: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Extended family household - includes grandparents, aunts, uncles, or other relatives.',
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive playground to test different household type selections and visual feedback.',
      },
    },
  },
};
