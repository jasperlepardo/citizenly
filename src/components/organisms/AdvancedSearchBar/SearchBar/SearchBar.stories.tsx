...
const residentFilterOptions = [
  ...
  { field: 'gender', label: 'Gender', type: 'select' as const, options: [
...
export const ResidentSearch: Story = {
  ...
  render: () => {
    ...
    const handleSearch = (searchTerm: string, filters: SearchFilter[]) => {
      ...
      setTimeout(() => {
        const mockResults = [
          { id: 1, name: 'Juan dela Cruz', age: 34, status: 'active', gender: 'male', household: 'HH-001' },
          { id: 2, name: 'Maria Santos', age: 29, status: 'active', gender: 'female', household: 'HH-002' },
          { id: 3, name: 'Pedro Garcia', age: 45, status: 'inactive', gender: 'male', household: 'HH-003' },
        ];
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-semibold mb-3">Barangay Resident Search</h3>
          <SearchBar
            ...
            filterOptions={[
              ...
              { field: 'civil_status', label: 'Civil Status', type: 'select', options: [
    ...
    <div className="space-y-4">
      ...
      <SearchBar
        ...
        filterOptions={[
          ...
          { field: 'household_type', label: 'Household Type', type: 'select', options: [
    ...
    <div className="space-y-4">
      ...
      <SearchBar
        ...
        filterOptions={[
          ...
          { field: 'business_type', label: 'Business Type', type: 'select', options: [
            { value: 'retail', label: 'Retail Store' },
            { value: 'restaurant', label: 'Restaurant/Food' },
            { value: 'service', label: 'Service Business' },
            { value: 'manufacturing', label: 'Manufacturing' },
          ]},
          { field: 'permit_status', label: 'Permit Status', type: 'select', options: [
            { value: 'active', label: 'Active' },
...
export const FilterTypesDemo: Story = {
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-3">All Filter Types Demo</h3>
        <SearchBar
          ...
          filterOptions={[
            ...
            { field: 'select_field', label: 'Select Field', type: 'select', options: [
      ...
      <div className="p-4 bg-gray-50 rounded border">
        <h4 className="font-semibold mb-2">Available Operators by Type:</h4>
  ...
  render: () => (
    <div className="space-y-8">
      <div className="max-w-sm">
        <h3 className="text-sm font-semibold mb-2">Mobile Layout</h3>
      ...
      <div className="max-w-2xl">
        <h3 className="text-sm font-semibold mb-2">Tablet Layout</h3>
      ...
      <div className="max-w-6xl">
        <h3 className="text-sm font-semibold mb-2">Desktop Layout</h3>
