/**
 * Resident Detail Sections Export Module
 * Provides barrel exports for all resident detail section components
 */
...
export { default as MigrationInfoCard } from './MigrationInfoCard';
export { default as AdminInfoCard } from './AdminInfoCard';