...
// Mock AddressHierarchy type for stories
...
const mockSearchAddresses = async (
  query: string,
  maxResults: number
  ...
  const filteredResults = mockAddresses.filter(
    address =>
...
export const BasicSearch: Story = {
  render: BasicSearchTemplate,
  args: {
    onSelect: () => {},
  },
};

const WithCustomPlaceholderTemplate = () => {
  const [selectedAddress, setSelectedAddress] = useState<AddressHierarchy | null>(null);
...
export const WithCustomPlaceholder: Story = {
  render: WithCustomPlaceholderTemplate,
  args: {
    onSelect: () => {},
  },
};

const LimitedResultsTemplate = () => {
  const [selectedAddress, setSelectedAddress] = useState<AddressHierarchy | null>(null);
...
export const LoadingStates: Story = {
  render: LoadingStatesTemplate,
  args: {
    onSelect: () => {},
  },
};

const RegionSearchTemplate = () => {
  const [selectedAddress, setSelectedAddress] = useState<AddressHierarchy | null>(null);
...
export const RegionSearch: Story = {
  render: RegionSearchTemplate,
  args: {
    onSelect: () => {},
  },
};

const FormIntegrationTemplate = () => {
...
export const PSGCIntegration: Story = {
  render: PSGCIntegrationTemplate,
  args: {
    onSelect: () => {},
  },
};

const AccessibilityDemoTemplate = () => {
  const [selectedAddress, setSelectedAddress] = useState<AddressHierarchy | null>(null);
...
export const AccessibilityDemo: Story = {
  render: AccessibilityDemoTemplate,
  args: {
    onSelect: () => {},
  },
};
