    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <div
        className={`relative flex w-full items-center font-system transition-colors focus-within:outline-none ${
          error
            ? 'bg-default rounded border border-red-600 focus-within:border-red-600 focus-within:shadow-[0px_0px_0px_4px_rgba(220,38,38,0.32)]'
            : 'bg-default rounded border border-default focus-within:border-blue-600 focus-within:shadow-[0px_0px_0px_4px_rgba(59,130,246,0.32)]'
        ...
        <div className="flex min-h-0 min-w-0 grow basis-0 flex-col items-center justify-center gap-0.5 px-1 py-0">
          ...
          <div className="font-montserrat flex w-full flex-col justify-center overflow-hidden text-ellipsis text-nowrap font-normal leading-5">
            <input
              ...
              className="font-montserrat placeholder:text-muted w-full border-0 bg-transparent text-base font-normal leading-5 text-gray-600 shadow-none outline-0 ring-0 focus:border-0 focus:shadow-none focus:outline-0 focus:ring-0 active:border-0 active:shadow-none active:outline-0 active:ring-0"
              style={{
                border: 'none',
                outline: 'none',
                boxShadow: 'none',
      ...
      {isOpen && (
        <div
          id={listboxId}
          role="listbox"
          className="ring-border-default bg-default absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-lg shadow-lg ring-1"
        >
          {loading ? (
              ...
              {options.map(option => (
                <li key={option.occupation_code}>
                  <button
                    ...
                    className="hover:bg-default-hover focus:bg-default-hover w-full px-3 py-2 text-left text-sm/6 text-gray-600 focus:outline-none"
                  >
