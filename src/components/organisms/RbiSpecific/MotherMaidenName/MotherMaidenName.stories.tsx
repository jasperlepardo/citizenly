...
export const CompleteInformation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example with complete mother information including advanced details like birth year and birthplace.',
      },
    },
  },
};
...
export const BasicInformation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example with basic required information - first name, middle name, and maiden last name.',
      },
    },
  },
};
...
export const WithSuffix: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example showing mother with suffix (Jr.) - less common but possible in Filipino naming.',
      },
    },
  },
};
...
export const UnknownMother: Story = {
  ...
  args: {
    value: {
      ...
      is_confidential: false,
      notes:
        'Adopted child - biological mother information unavailable. Legal adoption papers on file.',
    },
    disabled: false,
  },
  parameters: {
    docs: {
      description: {
        story:
          'Example for cases where mother information is unknown (adoption, abandonment, etc.).',
      },
    },
  },
};
...
export const IncompleteInformation: Story = {
  ...
  args: {
    value: {
      ...
      is_confidential: false,
      notes:
        'Middle name unknown. Mother left when resident was young. Limited information available.',
    },
    disabled: false,
  },
  parameters: {
...
export const WithSpecialCircumstances: Story = {
  ...
  args: {
    value: {
      ...
      is_confidential: false,
      notes:
        'Mother of mixed Filipino-Spanish heritage. Maiden name reflects Spanish ancestry. Family migrated from Spain in early 1900s.',
    },
    disabled: false,
  },
  parameters: {
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive playground to test different mother information scenarios and privacy settings.',
      },
    },
  },
};
