          ...
          >
            ...
            <div className="pr-8">
              <div className="mb-2 flex items-center space-x-3">
                ...
                <h4
                  className={`text-base font-medium ${value === option.value ? 'text-gray-900 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400'} `}
                >
                  {option.label}
                </h4>
              </div>
              ...
              <p
                className={`text-sm leading-relaxed ${value === option.value ? 'text-gray-700 dark:text-gray-300' : 'text-gray-600 dark:text-gray-400'} `}
              >
                {option.description}
              </p>
            </div>
