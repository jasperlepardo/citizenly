...
const meta: Meta<typeof FamilyRelationshipSelector> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Component for selecting family relationship/position within a household in the RBI system. Follows Philippine family structure conventions and provides clear relationship definitions.'
      }
    }
  },
  tags: ['autodocs'],
  argTypes: {
    value: {
      ...
      control: 'select',
      options: ['head', 'spouse', 'child', 'parent', 'sibling', 'grandparent', 'grandchild', 'in_law', 'other_relative', 'non_relative']
    },
    onChange: {
...
export const NonRelative: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Non-relative - household helper, boarder, or other non-family member living in the household.'
      }
    }
  }
}
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive playground to test different family relationship selections and their descriptions.'
      }
    }
  }
}