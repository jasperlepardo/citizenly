...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A unified navigation component that provides consistent navigation patterns across the RBI System. Supports icons, submenus, active states, and different variants for various use cases.'
      }
    }
  },
  tags: ['autodocs'],
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        ...
        <div className="bg-surface border border-default rounded-lg p-4">
          <Navigation 
            items={sampleMainNavigation.slice(0, 3)}
            bottomItems={[]}
            showIcons={true}
          />
        </div>
