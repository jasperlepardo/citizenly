...
export function TableRow({ children, className = '' }: TableRowProps) {
  return (
    <div
      className={`bg-default hover:bg-default-hover flex items-center transition-colors ${className}`}
    >
      {children}
    </div>
  );
...
export function TableCell({
  ...
  if (type === 'action') {
    return (
      <div className={`p-1 ${className}`}>
        <button className="bg-default hover:bg-default-hover rounded border border-default p-2 transition-colors">
  ...
  return (
    <div className={`flex-1 p-2 ${className}`}>
      <div className="font-body text-base font-normal leading-5 text-gray-600">{children}</div>
    </div>
  );
}
...
export function TableControls({ selectAll, actions, search }: TableControlsProps) {
  return (
    <div className="bg-default flex items-center justify-between p-0">
      <div className="flex items-center">
        {selectAll && (
          <div className="flex items-center gap-2 p-2">
            ...
            >
              ...
              <span className="font-body text-base font-normal text-gray-600">
        ...
        <div className="flex items-center gap-0 p-1">
          <button className="bg-default hover:bg-default-hover flex items-center gap-1 rounded border border-default p-2 transition-colors">
            <div className="size-5">
              <Image alt="list" className="block size-full" src={imgList} width={20} height={20} />
            </div>
            <span className="px-1 font-body text-base font-medium text-gray-600">Properties</span>
          </button>

          <button className="bg-default hover:bg-default-hover ml-1 flex items-center gap-1 rounded border border-default p-2 transition-colors">
            <div className="size-5">
              <Image alt="sort" className="block size-full" src={imgSort} width={20} height={20} />
            </div>
            <span className="px-1 font-body text-base font-medium text-gray-600">Sort</span>
          </button>
          ...
          <button className="bg-default hover:bg-default-hover ml-1 flex items-center gap-1 rounded border border-default p-2 transition-colors">
            ...
            <span className="px-1 font-body text-base font-medium text-gray-600">Filter</span>
          </button>

          <button className="bg-default hover:bg-default-hover ml-1 rounded border border-default p-1 transition-colors">
            <div className="size-5">
      ...
      {search && (
        <div className="p-1">
          <div className="w-60">
            <div className="bg-default relative rounded">
              <div className="flex items-center gap-1 p-2">
                ...
                <div className="flex-1 px-1">
                  <input
                    className="placeholder:text-muted w-full border-none bg-transparent font-body text-base font-normal leading-5 text-gray-600 outline-none"
