...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A flexible table component system with modular parts including Table, TableBody, TableRow, TableCell, and TableControls. Designed for the RBI System with built-in selection, search, and action capabilities.',
      },
    },
  },
  tags: ['autodocs'],
