...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A comprehensive personal information form component for the RBI System. Handles basic personal details including name, birth date, sex, civil status, and citizenship information with proper validation and error handling.'
      }
    }
  },
  tags: ['autodocs'],
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between p-4 bg-background rounded-lg border border-default">
          <div className="text-sm text-secondary">
            {isComplete ? '✅ All required fields completed' : '⚠️  Please complete all required fields'}
          </div>
