...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A responsive sidebar navigation template for the RBI System. Features mobile overlay with backdrop, desktop fixed positioning, unified navigation integration, and consistent branding. Designed to work seamlessly across all device sizes with proper accessibility support.'
      }
    }
  },
  decorators: [
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative z-60 bg-yellow-50 dark:bg-yellow-900/20 border-b border-yellow-200 dark:border-yellow-800 p-4">
        <div className="max-w-4xl mx-auto">
          <h3 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Interactive Sidebar Demo</h3>
            ...
            <div className="bg-surface rounded-lg border border-default p-6">
              ...
              <div className="space-y-3 text-sm text-secondary">
                <div className="flex items-center gap-2">
                  <span className={`w-2 h-2 rounded-full ${sidebarOpen ? 'bg-green-500' : 'bg-gray-400'}`}></span>
    ...
    <div className="space-y-6">
      <div className="bg-background rounded-lg border border-default p-6">
        ...
        <p className="text-secondary mb-4">
          The sidebar adapts its behavior based on screen size. Switch between views to see the differences.
        </p>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <h4 className="font-medium text-blue-800 dark:text-blue-200 mb-2">Current View: {currentView.charAt(0).toUpperCase() + currentView.slice(1)}</h4>
      ...
      <div className={`${currentView === 'mobile' ? 'max-w-sm' : 'w-full'} border-2 border-dashed border-gray-300 rounded-lg overflow-hidden`}>
          ...
          <div className={currentView === 'desktop' ? 'lg:pl-72' : ''}>
            <div className="p-6">
              ...
              <p className="text-secondary">
                This area contains the main application content. Notice how it shifts when the sidebar is present.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-background rounded-lg border border-default p-6">
        ...
        <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
          ...
          <p className="text-sm text-green-700 dark:text-green-300">
            ...
            It automatically handles responsive behavior and provides a consistent navigation experience 
            across all pages of the RBI System.
          </p>
        </div>
      </div>
      ...
      <div className="min-h-96 bg-background border border-default rounded-lg overflow-hidden relative">
        ...
        <div className="lg:pl-72 p-6">
          <div className="space-y-4">
            ...
            <p className="text-secondary">
              This demonstrates how the sidebar integrates with page content. The sidebar pushes content 
              to the right on desktop and overlays on mobile.
            </p>
            ...
            <div className="bg-surface rounded-lg border border-default p-4">
              ...
              <p className="text-sm text-secondary">
                ...
                On mobile, content remains full-width with the sidebar appearing as an overlay when opened.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="bg-background rounded-lg border border-default p-6">
        ...
        <p className="text-secondary mb-4">
          This demonstrates how the sidebar state can be controlled programmatically and how interactions are tracked.
        </p>
        ...
        <div className="lg:pl-72 p-6">
          <div className="bg-surface rounded-lg border border-default p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <span className={`w-3 h-3 rounded-full ${sidebarOpen ? 'bg-green-500' : 'bg-red-500'}`}></span>
                <span className="text-secondary">
                  Sidebar is currently <strong className="text-primary">{sidebarOpen ? 'open' : 'closed'}</strong>
                </span>
              </div>
              <div className="text-sm text-secondary">
                Total interactions logged: <strong className="text-primary">{interactions.length}</strong>
              </div>
            </div>
          </div>
        </div>
