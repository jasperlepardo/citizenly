...
export function ContactAddressStep({ formData, onChange, errors }: StepComponentProps) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-base/7 font-semibold text-gray-600">Contact & Address Information</h3>
      ...
      <div className="space-y-4">
        <h4 className="text-sm font-medium text-gray-600">Geographic Location</h4>
      ...
      {/* Address Details */}
      <div className="space-y-4">
        <h4 className="text-sm font-medium text-gray-600">Address Details</h4>
      ...
      <div className="space-y-4">
        <h4 className="text-sm font-medium text-gray-600">Household Assignment</h4>
        <p className="text-sm text-gray-600">
