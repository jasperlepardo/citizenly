...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A comprehensive multi-step resident registration form wizard for the RBI System. Features progressive form validation, security-hardened PhilSys number handling, PSOC occupation integration, household assignment, and complete resident data management with PSGC geographic compliance.'
      }
    }
  },
  decorators: [
      ...
      <div className="space-y-6">
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
          ...
          <p className="text-sm text-yellow-700 dark:text-yellow-300 mb-3">
            This wizard includes comprehensive validation at each step. Try proceeding without filling required fields to see the validation in action.
          </p>
    ...
    <div className="space-y-6">
      <div className="bg-background rounded-lg border border-default p-6">
        ...
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          <h4 className="font-medium text-blue-800 dark:text-blue-200 mb-2">Data Privacy & Security</h4>
          <p className="text-sm text-blue-700 dark:text-blue-300">
            This form wizard implements comprehensive data protection measures including PhilSys number 
            encryption, secure data transmission, and detailed audit logging. All personal information 
            is handled according to Philippine data privacy laws and regulations.
          </p>
        </div>
      </div>
      ...
      <div className="bg-background rounded-lg border border-default p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <h4 className="font-semibold text-green-800 dark:text-green-200 mb-2">PSOC Integration</h4>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
            <h4 className="font-semibold text-purple-800 dark:text-purple-200 mb-2">Security Measures</h4>
        ...
        <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-900/20 border border-gray-200 dark:border-gray-800 rounded-lg">
          <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Database Integration</h4>
