...
export const Horizontal: Story = {
  render: () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4">Horizontal with Spacing</h3>
...
export const Vertical: Story = {
  render: () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4">Vertical with Spacing</h3>
...
export const Attached: Story = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-semibold mb-4">Attached Horizontal</h3>
      ...
      <div>
        <h3 className="text-lg font-semibold mb-4">Attached Vertical</h3>
...
export const Toggle: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-8">
        <div>
          <h3 className="text-lg font-semibold mb-4">Text Alignment Toggle</h3>
          <ButtonGroup attached>
            <Button
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">View Toggle</h3>
          <ButtonGroup attached>
            <Button
...
export const Responsive: Story = {
  render: () => (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-lg font-semibold mb-4">Mobile-First Design</h3>
