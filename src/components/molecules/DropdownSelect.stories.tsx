...
const meta: Meta<typeof DropdownSelect> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A modern dropdown select component with search, keyboard navigation, and custom styling based on Figma design system.'
      }
    }
  },
  argTypes: {
...
const sampleOptions = [
  ...
  { value: 'option4', label: 'Very Long Option Name That Might Overflow', description: 'This option has a very long name to test text overflow' },
...
export const FullFeatures: Story = {
  args: {
    ...
    helperText: 'Searchable, clearable dropdown with keyboard navigation (Tab, Arrow keys, Enter, Escape, Home, End)',
    leftIcon: (
      <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
