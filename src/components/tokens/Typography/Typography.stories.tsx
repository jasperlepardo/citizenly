...
export const FontFamilies: Story = {
  ...
  render: () => (
    <div className="p-6">
      <h1 className="mb-6 text-3xl font-bold text-neutral-900">Font Families</h1>
      ...
      <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
        <h3 className="mb-2 font-semibold text-blue-900">🎯 Font Selection Rationale</h3>
...
export const BodyText: Story = {
  ...
  render: () => (
    <div className="p-6">
      ...
      {/* Reading Example */}
      <div className="mt-8 rounded-lg border border-neutral-200 bg-white p-6">
        <h3 className="mb-4 text-lg font-semibold text-neutral-900">📖 Reading Example</h3>

        <div className="space-y-6">
          <div>
            <h4 className="mb-2 font-medium text-neutral-700">Large Body Text (xl)</h4>
          ...
          <div>
            <h4 className="mb-2 font-medium text-neutral-700">Regular Body Text (md)</h4>
            <p style={typographyScale.body.md}>
          ...
          <div>
            <h4 className="mb-2 font-medium text-neutral-700">Small Body Text (sm)</h4>
...
export const FormTypography: Story = {
  ...
  render: () => (
    <div className="p-6">
      ...
      {/* Form Example */}
      <div className="mt-8 rounded-lg border border-neutral-200 bg-white p-6">
        <h3 className="mb-4 text-lg font-semibold text-neutral-900">🏷️ Form Typography Example</h3>

        <div className="max-w-md space-y-4">
          <div>
            <label style={typographyScale.label.lg} className="mb-1 block text-neutral-900">
              First Name *
            </label>
            <input
              type="text"
            ...
            />
            <p style={typographyScale.body.xs} className="mt-1 text-neutral-500">
              As written on your birth certificate
            </p>
          </div>

          <div>
            <label style={typographyScale.label.md} className="mb-1 block text-neutral-900">
              Email Address
            </label>
            <input
              type="email"
          ...
          <div>
            <label style={typographyScale.label.sm} className="mb-1 block text-neutral-700">
    ...
    <div className="p-6">
      ...
      <div className="mt-8 space-y-6">
        <div className="rounded-lg bg-neutral-900 p-4">
          <h4 className="mb-3 font-medium text-white">Code Block Example</h4>
...
async function registerResident(data) {
  ...
  return resident;
        ...
        <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-4">
          ...
          <p style={typographyScale.body.md} className="text-neutral-900">
...
export const AccessibilityExamples: Story = {
  ...
  render: () => (
    <div className="p-6">
      <h1 className="mb-6 text-3xl font-bold text-neutral-900">Typography Accessibility</h1>
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-lg border border-red-200">
          ...
          <div className="space-y-4 p-4">
            ...
            <div>
              <p className="text-base leading-none text-neutral-900">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
          <h3 className="mb-2 font-semibold text-blue-900">📏 Size Guidelines</h3>
      ...
      <div className="mt-6 rounded-lg border border-purple-200 bg-purple-50 p-4">
        <h3 className="mb-2 font-semibold text-purple-900">🧪 Testing Checklist</h3>
