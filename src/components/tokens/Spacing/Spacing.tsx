  ...
  return (
    <div className="flex items-center gap-4 rounded-lg border border-neutral-200 p-3">
      <div className="flex-shrink-0">
        ...
        {showValue && <div className="text-xs text-neutral-500">{value}</div>}
      </div>

      <div className="flex flex-1 items-center">
        <div
          className="flex-shrink-0 bg-blue-500 transition-all"
          style={{
        ...
        />
        {isLarge && <div className="ml-2 text-xs text-neutral-400">(scaled down for display)</div>}
      </div>
    </div>
  );
};
...
export const SpacingDemo: React.FC<SpacingDemoProps> = ({ title, spacing, children }) => (
  <div className="mb-6">
    <h4 className="text-md mb-2 font-medium text-neutral-900">
      {title} <span className="font-mono text-sm text-neutral-500">({spacing})</span>
    </h4>
...
const Spacing: React.FC = () => {
  return (
    <div className="mx-auto max-w-6xl p-6">
      <div className="mb-8">
        <h1 className="mb-2 text-3xl font-bold text-neutral-900">Design Tokens: Spacing</h1>
      ...
      {/* Base Spacing Scale */}
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-neutral-900">Base Spacing Scale</h2>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          {/* Small Values */}
          <div>
            <h3 className="mb-4 text-lg font-medium text-neutral-900">Small Values (0-24px)</h3>
            <div className="space-y-2">
          ...
          {/* Medium Values */}
          <div>
            <h3 className="mb-4 text-lg font-medium text-neutral-900">Medium Values (28-96px)</h3>
            <div className="space-y-2">
              {Object.entries(spacingTokens)
                .filter(([_, value]) => {
        ...
        {/* Large Values */}
        <div className="mt-8">
          <h3 className="mb-4 text-lg font-medium text-neutral-900">Large Values (112px+)</h3>
      ...
      {/* Semantic Spacing */}
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-neutral-900">Semantic Spacing</h2>
        <p className="mb-6 text-neutral-600">
      ...
      {/* Visual Examples */}
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-neutral-900">Spacing in Action</h2>
        ...
        <SpacingDemo title="Component Internal Spacing" spacing="12px">
          ...
          >
            <h4 className="mb-2 font-semibold text-blue-900">Card Component</h4>
        ...
        <SpacingDemo title="Form Element Spacing" spacing="16px field gap">
          <div className="max-w-md">
            <div style={{ marginBottom: semanticSpacing.form.fieldGap }}>
              <label className="mb-1 block text-sm font-medium text-neutral-900">First Name</label>
              <input
                type="text"
            ...
            <div style={{ marginBottom: semanticSpacing.form.fieldGap }}>
              <label className="mb-1 block text-sm font-medium text-neutral-900">Last Name</label>
              <input
                type="text"
                className="w-full rounded-md border border-neutral-300 px-3 py-2"
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button className="rounded-md border border-neutral-300 px-4 py-2 text-neutral-700">
                Cancel
              </button>
            </div>
          </div>
      ...
      {/* Grid System */}
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-neutral-900">4px Grid System</h2>
        <p className="mb-6 text-neutral-600">
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-6">
          ...
          <div className="relative">
            ...
            <div className="relative z-10 p-4">
              <div className="mb-4 inline-block rounded bg-blue-500 p-4 text-white">
                16px padding (4 × 4px)
              </div>
              <div className="mb-6 ml-8 inline-block rounded bg-green-500 p-6 text-white">
                24px padding (6 × 4px)
              </div>
              <div className="inline-block rounded bg-purple-500 p-8 text-white">
                32px padding (8 × 4px)
              </div>
            </div>
          </div>
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-6">
        <h3 className="mb-4 text-lg font-semibold text-blue-900">📏 Spacing Guidelines</h3>
        <div className="grid grid-cols-1 gap-6 text-sm md:grid-cols-2">
          <div>
            <h4 className="mb-2 font-semibold text-blue-900">Component Spacing</h4>
          ...
          <div>
            <h4 className="mb-2 font-semibold text-blue-900">Layout Spacing</h4>
            <ul className="space-y-1 text-blue-800">
