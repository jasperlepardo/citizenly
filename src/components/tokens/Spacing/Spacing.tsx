  ...
  return (
    <div className="flex items-center gap-4 rounded-lg border border-gray-200 p-3">
      ...
      <div className="flex flex-1 items-center">
        ...
        />
        {isLarge && <div className="ml-2 text-xs text-gray-400">(scaled down for display)</div>}
      </div>
    </div>
  );
};
...
export const SpacingDemo: React.FC<SpacingDemoProps> = ({ title, spacing, children }) => (
  <div className="mb-6">
    <h4 className="text-md mb-2 font-medium text-gray-900">
      {title} <span className="font-mono text-sm text-gray-500">({spacing})</span>
    </h4>
...
const Spacing: React.FC = () => {
  return (
    <div className="mx-auto max-w-6xl p-6">
      <div className="mb-8">
        <h1 className="mb-2 text-3xl font-bold text-gray-900">Design Tokens: Spacing</h1>
      ...
      {/* Base Spacing Scale */}
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-gray-900">Base Spacing Scale</h2>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          {/* Small Values */}
          <div>
            <h3 className="mb-4 text-lg font-medium text-gray-900">Small Values (0-24px)</h3>
            <div className="space-y-2">
          ...
          {/* Medium Values */}
          <div>
            <h3 className="mb-4 text-lg font-medium text-gray-900">Medium Values (28-96px)</h3>
            <div className="space-y-2">
              {Object.entries(spacingTokens)
                .filter(([_, value]) => {
        ...
        {/* Large Values */}
        <div className="mt-8">
          <h3 className="mb-4 text-lg font-medium text-gray-900">Large Values (112px+)</h3>
      ...
      {/* Semantic Spacing */}
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-gray-900">Semantic Spacing</h2>
        <p className="mb-6 text-gray-600">
      ...
      {/* Visual Examples */}
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-gray-900">Spacing in Action</h2>
        ...
        <SpacingDemo title="Component Internal Spacing" spacing="12px">
          ...
          >
            <h4 className="mb-2 font-semibold text-gray-900">Card Component</h4>
        ...
        <SpacingDemo title="Form Element Spacing" spacing="16px field gap">
          <div className="max-w-md">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button className="rounded-md border border-gray-300 px-4 py-2 text-gray-700">
                Cancel
              </button>
            </div>
          </div>
      ...
      {/* Grid System */}
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-gray-900">4px Grid System</h2>
        <p className="mb-6 text-gray-600">
          All spacing values are multiples of 4px to ensure consistent alignment and rhythm.
        </p>

        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <h3 className="mb-4 font-semibold text-gray-900">Grid Visualization</h3>
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-6">
        <h3 className="mb-4 text-lg font-semibold text-gray-900">📏 Spacing Guidelines</h3>
        <div className="grid grid-cols-1 gap-6 text-sm md:grid-cols-2">
          <div>
            <h4 className="mb-2 font-semibold text-gray-900">Component Spacing</h4>
          ...
          <div>
            <h4 className="mb-2 font-semibold text-gray-900">Layout Spacing</h4>
            <ul className="space-y-1 text-gray-800">
        ...
        <div className="mt-6 rounded-lg border border-blue-300 bg-blue-100 p-4">
          <h4 className="mb-2 font-semibold text-gray-900">💡 Pro Tips</h4>
