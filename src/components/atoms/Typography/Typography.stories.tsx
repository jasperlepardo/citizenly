  ...
  render: () => (
    <div className="max-w-2xl space-y-4">
      <Typography variant="bodyLarge">
        Body Large - This is larger body text used for introductory paragraphs or emphasis. It
        provides good readability for important content that needs to stand out from regular text.
      </Typography>

      <Typography variant="bodyMedium">
        Body Medium - This is the standard body text used throughout the application. It&rsquo;s
        designed for optimal readability and is the most commonly used text variant for content.
      </Typography>

      <Typography variant="bodySmall">
        Body Small - This is smaller body text used for secondary information, fine print, or when
        space is limited but readability is still important.
      </Typography>

      <Typography variant="caption">
        Caption - This is the smallest text variant, typically used for image captions, metadata,
        timestamps, or other supplementary information.
      </Typography>
    </div>
  ),
};
...
export const UIElements: Story = {
  render: () => (
    <div className="space-y-6">
      ...
      <div>
        <Typography variant="code" as="code" className="rounded bg-gray-100 px-2 py-1">
  ...
  render: () => (
    <div className="space-y-4">
      ...
      <Typography variant="display">
        Display - Uses display font for headings and emphasis
      </Typography>
      <Typography variant="body">Body - Uses body font for readable content</Typography>
      <Typography variant="mono" as="code">
        Mono - Uses monospace font for code and technical content
      </Typography>
    </div>
  ),
};
...
export const ConvenienceComponents: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <BodyTextComponent>
        Convenience Component - Body Text. This uses the BodyText component which automatically
        applies the bodyMedium variant and paragraph element.
      </BodyTextComponent>

      <Caption>
        Convenience Component - Caption. This uses the Caption component for supplementary text and
        metadata.
      </Caption>
    </div>
  ),
...
export const SemanticUsage: Story = {
  render: () => (
    <article className="max-w-3xl space-y-4">
      ...
      <BodyTextComponent>
        This is a regular paragraph with standard body text. It&rsquo;s designed for optimal
        readability and comfortable reading experience.
      </BodyTextComponent>

      <BodyTextComponent>
        Here&rsquo;s another paragraph to show proper spacing and typography hierarchy. Notice how
        the text flows naturally and maintains good readability.
      </BodyTextComponent>
      ...
      <BodyTextComponent>
        ...
        <Typography as="strong" className="font-semibold">
          strong emphasis
        </Typography>{' '}
      ...
      <Caption>
        Figure 1: This would be a caption for an image or diagram, providing additional context or
        attribution.
      </Caption>
    </article>
  ),
  ...
  render: () => (
    <div className="space-y-4">
      ...
      <Typography variant="bodyMedium" className="sm:text-lg md:text-xl">
        This text gets larger on bigger screens by combining the base variant with responsive
        utility classes.
      </Typography>
    </div>
  ),
