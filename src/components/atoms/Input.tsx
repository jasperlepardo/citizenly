...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ 
    ...
    return (
      <div>
        <div className={`relative rounded transition-colors font-system focus-within:outline-none ${
          actualState === 'error' 
        ...
        {/* Error Message */}
        {error && (
          <p className="text-xs text-red-500 mt-2 font-montserrat leading-[14px]">
            {error}
          </p>
        )}
      </div>
