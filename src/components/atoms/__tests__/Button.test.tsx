...
describe('Button Component', () => {
  ...
  describe('Icons', () => {
    ...
    it('renders icon only button correctly', () => {
      ...
      render(<Button iconOnly leftIcon={<Icon />}>Hidden Text</Button>)
    ...
    it('adjusts icon-only button size correctly', () => {
      ...
      const { unmount } = render(<Button iconOnly leftIcon={<Icon />} size="sm">Icon</Button>)
      const smallButton = screen.getByRole('button')
      expect(smallButton).toHaveClass('h-8', 'w-8')
      
      // Clean up and test large size
      unmount()
      render(<Button iconOnly leftIcon={<Icon />} size="lg">Icon</Button>)
      const largeButton = screen.getByRole('button')
      expect(largeButton).toHaveClass('h-10', 'w-10')
    })
  })
