...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ 
    ...
    const rightPadding = rightElements.length > 0 ? 
      rightElements.length === 1 ? 'pr-10' : 
      rightElements.length === 2 ? 'pr-16' : 'pr-20' : 'pr-3';
    ...
    return (
      <div className="relative">
        <div
          className={`relative flex w-full items-center font-system transition-colors focus-within:outline-hidden ${
            error
        ...
        >
          {/* Left Icon */}
          {leftIcon && (
            <div className="flex size-5 shrink-0 items-center justify-center text-gray-400 dark:text-gray-500 mr-2">
              {leftIcon}
            </div>
          )}
          ...
          <div className="flex items-center space-x-2">
            ...
            {showClearButton && (
              <button
                type="button"
                className="flex size-5 shrink-0 items-center justify-center text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded transition-colors duration-200"
                onClick={handleClear}
