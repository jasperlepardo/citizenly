...
export const Dismissible: Story = {
    ...
    return (
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-500">
          Click the × button to dismiss/clear the input
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Input with dismissible functionality. Shows a dismiss button when there is content.',
      },
    },
  },
};
  ...
  render: () => {
    ...
    return (
      <div className="space-y-2">
        ...
        />
        <p className="text-sm text-gray-500">
          Search input with left icon and clear functionality
        </p>
      </div>
    );
  },
...
export const PasswordAllFeatures: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Password input showcasing all features: left icon, password toggle, and dismissible.',
      },
    },
  },
};
...
export const Interactive: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <div>
          <label htmlFor="interactive-input" className="block text-sm font-medium mb-1">
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive example showing real-time validation, state management, and clearable functionality.',
      },
    },
  },
};
