...
const checkboxInputVariants = cva(
  "relative border rounded transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1",
  {
    variants: {
      variant: {
        default: "border-[#d4d4d4] bg-white checked:bg-[#7c3aed] checked:border-[#7c3aed] focus:ring-[#7c3aed]/20",
        primary: "border-[#d4d4d4] bg-white checked:bg-[#2563eb] checked:border-[#2563eb] focus:ring-[#2563eb]/20",
        error: "border-[#dc2626] bg-white checked:bg-[#dc2626] checked:border-[#dc2626] focus:ring-[#dc2626]/20",
  ...
  ({ 
    ...
    return (
      <div className="w-full">
        ...
        {/* Error Message */}
        {errorMessage && (
          <p className="text-xs text-[#b91c1c] font-['Montserrat'] mt-1 ml-6">
            {errorMessage}
          </p>
        )}
      </div>
