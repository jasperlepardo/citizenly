...
const meta = {
  ...
  argTypes: {
    variant: {
      control: { type: 'select' },
      options: [
        'primary', 'primary-subtle', 'primary-faded', 'primary-outline',
        'secondary', 'secondary-subtle', 'secondary-faded', 'secondary-outline',
        'success', 'success-subtle', 'success-faded', 'success-outline',
        'warning', 'warning-subtle', 'warning-faded', 'warning-outline',
        'danger', 'danger-subtle', 'danger-faded', 'danger-outline',
        'ghost', 'link'
      ],
    },
    size: {
...
export const Variants: Story = {
  render: () => (
    <div className="grid grid-cols-4 gap-4 items-center">
      ...
      <IconButton variant="secondary-outline" icon={HeartIcon} aria-label="Secondary outline heart" />
