...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const defaultBeforeIcon = (
      <div className="flex size-5 items-center justify-center text-gray-600">
    ...
    return (
      <div>
        <div
          className={`relative rounded font-system transition-colors focus-within:outline-none ${
            actualState === 'error'
              ? 'bg-default border border-red-600 focus-within:border-red-600 focus-within:shadow-[0px_0px_0px_4px_rgba(220,38,38,0.32)]'
              : 'bg-default border border-default focus-within:border-blue-600 focus-within:shadow-[0px_0px_0px_4px_rgba(59,130,246,0.32)]'
