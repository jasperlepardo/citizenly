...
const DefaultKeyboardNavigableList = () => {
...
export const Default: Story = {
  ...
  render: () => <DefaultKeyboardNavigableList />,
};

const MenuKeyboardNavigableList = () => {
...
export const Menu: Story = {
  ...
  render: () => <MenuKeyboardNavigableList />,
};

const HorizontalTabsKeyboardNavigableList = () => {
...
export const HorizontalTabs: Story = {
  ...
  render: () => <HorizontalTabsKeyboardNavigableList />,
};

const WithIconsKeyboardNavigableList = () => {
  const [selected, setSelected] = useState<string>('');
...
export const WithIcons: Story = {
  ...
  render: () => <WithIconsKeyboardNavigableList />,
};

const ComposableListItemsComponent = () => {
...
export const ComposableListItems: Story = {
  ...
  render: () => <ComposableListItemsComponent />,
};

const LongListKeyboardNavigableList = () => {
  const [selected, setSelected] = useState<string>('');
...
export const LongList: Story = {
  ...
  render: () => <LongListKeyboardNavigableList />,
};
