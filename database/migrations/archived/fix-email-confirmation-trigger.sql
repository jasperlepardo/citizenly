-- Fix the email confirmation trigger to include auto-population of geographic codes
-- This ensures all future signups will have complete geographic hierarchy
...
BEGIN
    ...
    IF OLD.email_confirmed_at IS NULL AND NEW.email_confirmed_at IS NOT NULL THEN
        ...
        INSERT INTO auth_user_profiles (
            ...
            role_id,
            barangay_code,
            city_municipality_code,    -- Add city code
            province_code,             -- Add province code
            region_code,               -- Add region code
            is_active,
            created_at,
            updated_at
        ) VALUES (
            ...
            v_barangay_code,
            v_city_code,               -- Use derived city code
            v_province_code,           -- Use derived province code
            v_region_code,             -- Use derived region code
            true,
            NOW(),
            NOW()
            ...
            city_municipality_code = EXCLUDED.city_municipality_code,   -- Update city code
            province_code = EXCLUDED.province_code,                     -- Update province code
            region_code = EXCLUDED.region_code,                         -- Update region code
            is_active = true,
            updated_at = NOW();
