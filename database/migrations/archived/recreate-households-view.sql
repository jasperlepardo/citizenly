-- Drop and recreate the view with correct structure for frontend

DROP VIEW IF EXISTS api_households_with_members;

CREATE VIEW api_households_with_members AS
SELECT 
    h.code,
    h.name,
    h.house_number,
...
-- Show the data with correct structure
SELECT 
    code,
    street_name,
    house_number,
